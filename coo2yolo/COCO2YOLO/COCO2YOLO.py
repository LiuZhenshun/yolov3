...
class COCO2YOLO:
    ...
    def _save_txt(self, anno_dict):
        ...
        for k, v in anno_dict.items():
            ...
            imag_name = file_name.split(".")[0] + ".jpg"
            ...
            for obj in v:
                ...
                #     continue
                if fag == 0:
                    f = open(os.path.join(output, file_name), 'w', encoding='utf-8')
                    f1 = open(os.path.join(output, 'val.txt'), 'a', encoding='utf-8')
                    f1.write('data/2022_11_03_cloudy_thermal/JPEGImages/'+ imag_name + '\n')
                    fag = 1
                print(k, v)
